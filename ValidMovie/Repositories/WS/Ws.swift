...
class Ws : NSObject
{
    func getArray(view: UIViewController, Ok: @escaping ((NSArray) -> Void),Error : @escaping((String) -> Void), todoEndpointt:(String))
    {
        ...
        //   let todoEndpoint: String = "http://190.216.128.52/OM.MobileApi.Public/api/Agents?docNumber=112233000&docType=C"
        //   let todoEndpoint: String = "http://190.216.128.52/OM.MobileApi.Public/api/Contracts?docNumber=70720&docType=E"
